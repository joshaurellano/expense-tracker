...
class _EditscreenState extends State<Editscreen> {
  ...
  @override
    void initState() {
      super.initState();
      expenseNameController = TextEditingController(text: widget.expenseDetail.description);
      expenseAmountcontroller = TextEditingController(text: widget.expenseDetail.amount.toStringAsFixed(0));
      selectedCategory = widget.expenseDetail.category;
      selectedDate = widget.expenseDetail.selectDate;
    }
  @override
  void dispose() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edit Expenses', style: 
